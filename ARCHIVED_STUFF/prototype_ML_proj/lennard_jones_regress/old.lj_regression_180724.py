...
def calc_lennard_jones_all_atoms(
    ...
    atoms_list,
    reference_atoms,
    return_quantity="energies"  # 'energies' or 'forces'
    ):
    """Calculate the Lennard Jones formation energies of list of atoms.

    Now can also return list of force arrays for all structures.
    ...
    if return_quantity == "forces":
        for atoms_i in atoms_list:
            ...
            lj_forces_i = lennard_jones_sp(
                ...
                return_quantity="forces",  # 'energy', 'forces', 'both', 'energy&forces'
                )
...
def objective(
    ...
    lj_forces = calc_lennard_jones_all_atoms(
        ...
        atoms_list,
        reference_atoms,
        return_quantity="forces",  # 'energies' or 'forces'
        )
