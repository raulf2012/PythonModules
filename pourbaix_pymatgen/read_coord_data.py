def read_coord_data(elem_1,elem_2, mat1_co=0.5):
	...
	Args:
		...
		mat1_co:
	"""
	#start_fold - read_coord_data
	from monty.json import MontyEncoder, MontyDecoder
	import json
	import os
	import fnmatch

	# This script will rebuild the coord object from a locally saved file
	coord = []

	direct = '/home/flores12/01_ORR-MatStabScreen/01_virenv-pymatgen/02_loc_PD_data/02_local_PD_line_data/'
#	direct = '/home/flores12/01_ORR-MatStabScreen/01_virenv-pymatgen/88_tmp/08_local_PD_data/02_local_PD_line_data/'
#	direct = '/home/flores12/01_ORR-MatStabScreen/01_virenv-pymatgen/88_tmp/08_local_PD_data/01_making_local_data/'
