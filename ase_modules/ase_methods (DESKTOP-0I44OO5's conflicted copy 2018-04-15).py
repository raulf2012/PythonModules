...
def set_init_mag_moms(
    ...
    def select_magmom_meth(
        ...
        """Applies to necessary logic to decide how to initilize the magmoms.
        ...
        if magmoms is not None:
            ...
            # TODO Implement this featrure in simple_mag_moms, providing dict
            # will update the init magmom dict
            ...
            if read_from_file and spinpol_calc is True:
                text = ("set_init_mag_moms | "
                        "Using magmom_init file for initial magnetic moments")
                print(text); sys.stdout.flush()
